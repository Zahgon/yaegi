...
func (W _go_types_Object) Exported() bool       { _ = "STUB: not implemented"; return false }
func (W _go_types_Object) Id() string           { _ = "STUB: not implemented"; return "" }
func (W _go_types_Object) Name() string         { _ = "STUB: not implemented"; return "" }
func (W _go_types_Object) Parent() *types.Scope { _ = "STUB: not implemented"; return nil }
func (W _go_types_Object) Pkg() *types.Package  { _ = "STUB: not implemented"; return nil }
func (W _go_types_Object) Pos() token.Pos       { _ = "STUB: not implemented"; return *new(token.Pos) }
func (W _go_types_Object) String() string       { _ = "STUB: not implemented"; return "" }

func (W _go_types_Object) Type() types.Type { _ = "STUB: not implemented"; return *new(types.Type) }
...
func (W _go_types_Sizes) Alignof(T types.Type) int64 { _ = "STUB: not implemented"; return 0 }
func (W _go_types_Sizes) Offsetsof(fields []*types.Var) []int64 {
	_ = "STUB: not implemented"
	return nil
}
func (W _go_types_Sizes) Sizeof(T types.Type) int64 { _ = "STUB: not implemented"; return 0 }
...
func (W _go_types_Type) String() string { _ = "STUB: not implemented"; return "" }

func (W _go_types_Type) Underlying() types.Type { _ = "STUB: not implemented"; return *new(types.Type) }
