...
func (W _os_DirEntry) IsDir() bool       { _ = "STUB: not implemented"; return false }
func (W _os_DirEntry) Name() string      { _ = "STUB: not implemented"; return "" }
func (W _os_DirEntry) Type() fs.FileMode { _ = "STUB: not implemented"; return *new(fs.FileMode) }
...
func (W _os_FileInfo) IsDir() bool        { _ = "STUB: not implemented"; return false }
func (W _os_FileInfo) ModTime() time.Time { _ = "STUB: not implemented"; return *new(time.Time) }
func (W _os_FileInfo) Mode() fs.FileMode  { _ = "STUB: not implemented"; return *new(fs.FileMode) }
func (W _os_FileInfo) Name() string       { _ = "STUB: not implemented"; return "" }
func (W _os_FileInfo) Size() int64        { _ = "STUB: not implemented"; return 0 }
func (W _os_FileInfo) Sys() any           { _ = "STUB: not implemented"; return *new(any) }
...
func (W _os_Signal) Signal()        { _ = "STUB: not implemented"; return }
func (W _os_Signal) String() string { _ = "STUB: not implemented"; return "" }
