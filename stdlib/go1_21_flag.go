...
func (W _flag_Getter) Get() any            { _ = "STUB: not implemented"; return *new(any) }
func (W _flag_Getter) Set(a0 string) error { _ = "STUB: not implemented"; return nil }
func (W _flag_Getter) String() string      { _ = "STUB: not implemented"; return "" }
...
func (W _flag_Value) Set(a0 string) error { _ = "STUB: not implemented"; return nil }
func (W _flag_Value) String() string      { _ = "STUB: not implemented"; return "" }
