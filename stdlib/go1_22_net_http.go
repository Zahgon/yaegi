...
func (W _net_http_CloseNotifier) CloseNotify() <-chan bool { _ = "STUB: not implemented"; return nil }
...
func (W _net_http_File) Close() error                     { _ = "STUB: not implemented"; return nil }
func (W _net_http_File) Read(p []byte) (n int, err error) { _ = "STUB: not implemented"; return 0, nil }
...
func (W _net_http_Flusher) Flush() { _ = "STUB: not implemented"; return }
...
func (W _net_http_ResponseWriter) WriteHeader(statusCode int) { _ = "STUB: not implemented"; return }
